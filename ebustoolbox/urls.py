...
urlpatterns = [
    ...
    path("result/<uuid:task_id>/cumulative_coverage/", views.get_cumulative_energy, name="get_cumulative_energy"),
    path("result/<uuid:task_id>/rotation_table/", views.get_rotation_table_data, name="get_rotation_table_data"),
