...
urlpatterns = [
    ...
    path("input/scenario_overview/<uuid:task_id>", views.scenario_overview, name="scenario_overview"),
    ...
    path("run_simulation/<uuid:task_id>/", views.run_simulation, name="simulate"),
]
