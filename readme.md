...
2. Install prerequisites
    ...
    3. The software requires either
         a. SQLite3 with SpatiaLite package ([Instructions](https://docs.djangoproject.com/en/4.2/ref/contrib/gis/install/spatialite/))
         b. PostgreSQL database with the PostGIS package.
   ...
   ````text
    ...
    # Use something like DATABASE_URL="spatialite:///database.sqlite" if using sqlite
